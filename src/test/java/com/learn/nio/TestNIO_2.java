...
public class TestNIO_2 {
  ...
  public void test7() throws IOException {
    SeekableByteChannel newByteChannel = Files.newByteChannel(Paths.get("resource/nio/hello.txt"), StandardOpenOption.READ);
  ...
  public void test6() throws IOException {
    Path path = Paths.get("resource/nio/hello.txt");
//		System.out.println(Files.exists(path, LinkOption.NOFOLLOW_LINKS));
  ...
  public void test5() throws IOException {
    Path path1 = Paths.get("resource/nio/hello.txt");
    Path path2 = Paths.get("resource/nio/hello2.txt");
...
//		Files.move(path1, path2, StandardCopyOption.ATOMIC_MOVE);
  ...
  public void test4() throws IOException {
    Path dir = Paths.get("resource/nio");
    //创建单个文件夹
//		Files.createDirectory(dir);
    //创建所需的全部文件夹
    Files.createDirectories(dir);

    Path file = Paths.get("resource/nio/hello.txt");
    Path file2 = Paths.get("resource/nio/hello2.txt");
    //新建文件
...
//		Files.deleteIfExists(file);
  ...
  public void test3() throws IOException {
    Path path1 = Paths.get("D:/workspace-demo/resource/新建文本文档.txt");
    Path path2 = Paths.get("D:/workspace-demo/resource/新建文本文档2.txt");
  ...
  @Test
  public void test2() {
    Path path = Paths.get("D:/workspace-demo/resource/新建文本文档.txt");
...
//		System.out.println(newPath);
    ...
    Path path2 = Paths.get("resource/新建文本文档.txt");
  ...
  public void test1() {
    ...
    System.out.println(path.endsWith("新建文本文档.txt"));
